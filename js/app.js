(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main__slider")) new swiper_core_Swiper(".main__slider", {
            ...
            on: {
                slideChange: function() {
                    ...
                    var videos = activeSlide.getElementsByTagName("video");
                    for (var i = 0; i < videos.length; i++) videos[i].play();
                }
            }
        });
        if (document.querySelector(".secondslider__slider")) new swiper_core_Swiper(".secondslider__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".discount__slider")) new swiper_core_Swiper(".discount__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".youtube__slider")) new swiper_core_Swiper(".youtube__slider", {
    ...
    function updateTimer() {
        ...
        if (timeRemaining <= 0) document.getElementById("timer").innerHTML = "Сегодня уже закончился"; else {
